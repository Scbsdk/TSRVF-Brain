...
//double* mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
	int i, j, k, l, n, M, N, Eidx, Fidx, Ftmp, Fmin, Num, *Path, *xy, x, y, cnt;
	const double *q1, *q2;
	double *q2L, *yy, *D, *tmp, *E, *Final_E, Etmp, Emin, t, a, b, lam = 0;
